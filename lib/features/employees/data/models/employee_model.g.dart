...
EmployeeModel _employeeModelDeserialize(
  ...
  object.role =
      _EmployeeModelroleValueEnumMap[reader.readStringOrNull(offsets[4])] ??
...
P _employeeModelDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 3:
      return (reader.readString(offset)) as P;
    case 4:
      return (_EmployeeModelroleValueEnumMap[reader.readStringOrNull(offset)] ??
...
const _EmployeeModelroleEnumValueMap = {
  r'productDesigner': r'productDesigner',
  r'flutterDeveloper': r'flutterDeveloper',
  r'qaTester': r'qaTester',
  r'productOwner': r'productOwner',
};
const _EmployeeModelroleValueEnumMap = {
  r'productDesigner': EmployeeRole.productDesigner,
  r'flutterDeveloper': EmployeeRole.flutterDeveloper,
  r'qaTester': EmployeeRole.qaTester,
  r'productOwner': EmployeeRole.productOwner,
};
...
extension EmployeeModelQueryFilter
  ...
  QueryBuilder<EmployeeModel, EmployeeModel, QAfterFilterCondition> roleMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
